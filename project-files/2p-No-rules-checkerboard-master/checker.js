...
var checkers = [
  ...
  { row: 1, cell: 10, color: "white" },
  { row: 2, cell: 1, color: "white" },
  { row: 2, cell: 3, color: "white" },
  { row: 2, cell: 5, color: "white" },
  { row: 2, cell: 7, color: "white" },
  { row: 2, cell: 9, color: "white" },
  { row: 3, cell: 2, color: "white" },
  { row: 3, cell: 4, color: "white" },
  { row: 3, cell: 6, color: "white" },
  { row: 3, cell: 8, color: "white" },
  { row: 3, cell: 10, color: "white" },
  { row: 4, cell: 1, color: "white" },
  { row: 4, cell: 3, color: "white" },
  { row: 4, cell: 5, color: "white" },
  { row: 4, cell: 7, color: "white" },
  { row: 4, cell: 9, color: "white" },

  { row: 7, cell: 2, color: "black" },
  { row: 7, cell: 4, color: "black" },
  { row: 7, cell: 6, color: "black" },
  { row: 7, cell: 8, color: "black" },
  { row: 7, cell: 10, color: "black" },
  { row: 8, cell: 1, color: "black" },
  { row: 8, cell: 3, color: "black" },
  { row: 8, cell: 5, color: "black" },
  { row: 8, cell: 7, color: "black" },
  { row: 8, cell: 9, color: "black" },
  { row: 9, cell: 2, color: "black" },
  { row: 9, cell: 4, color: "black" },
  { row: 9, cell: 6, color: "black" },
  { row: 9, cell: 8, color: "black" },
  { row: 9, cell: 10, color: "black" },
  { row: 10, cell: 1, color: "black" },
  { row: 10, cell: 3, color: "black" },
  { row: 10, cell: 5, color: "black" },
  { row: 10, cell: 7, color: "black" },
  { row: 10, cell: 9, color: "black" },
];
